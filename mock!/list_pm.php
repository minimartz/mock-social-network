...
<div class="box">
	<div class="box_right">
    	<a href="list_pm.php">Your messages(<?php echo $nb_new_pm; ?>)</a> - <a href="profile.php?username=<?php echo $_SESSION['username']; ?>"><?php echo htmlentities($_SESSION['username'], ENT_QUOTES, 'UTF-8'); ?></a> (<a href="logout.php">Logout</a>)
    </div>
    <div class="clean"></div>
</div>
...
?>
	<tr>
    	...
    	<td><a href="profile.php?id=<?php echo $dn1['id']; ?>"><?php echo htmlentities($dn1['username'], ENT_QUOTES, 'UTF-8'); ?></a></td>
...
?>
	<tr>
    	...
    	<td><a href="profile.php?username=<?php echo $dn2['id']; ?>"><?php echo htmlentities($dn2['username'], ENT_QUOTES, 'UTF-8'); ?></a></td>
    </tr>
<?php
}
...
{
?>
<h2>You must be logged to access this page:</h2><br /><br />
<a href="index.php">Login</a><br/><a href="register.php">Signup</a><br />
        </div>
    </form>
</div>
<?php
