...
if($_SESSION['id'])
{
	...
	echo "<a href=\"profile.php?username=".$_SESSION['username']."\">View Profile</a><br />";
	...
	<input id="age" type="number" name="age" min="13" max="100">
	</div>
	...
	<textarea id="status" cols="40" rows="4" name="status"><?php echo $row['status']; ?></textarea>
	</div>

	<input type="submit" name="update" value="Update">
	</form></div>
	
	<b>Note that the "age" select is not supported in Firefox or IE.</b>
